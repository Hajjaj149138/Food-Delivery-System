...
require_once '../models/foodmodel.php';
    ...
    if(isset($_REQUEST['submit'])){
        $foodid = $_REQUEST['id'];
            ...
            $fooddetails = ['username'=>$username, 'foodname'=> $foodname, 'description'=> $description, 'price' => $price, 'category'=> $category, 'image'=> $image , 'foodid'=> $foodid ];
    
            
            $status = editfood($fooddetails);
            if($status){
