            ...
            <tr>
                ...
                <td>
                        ...
                        <fieldset class="fieldset">
                                <legend> USER </legend>
                                <a class="btn"  href="adminlist.php">Admins</a>
                                <h1></h1>
                                <a class="btn"  href="customerlist.php">Customers</a>
                                <h1></h1>
                                 <a class="btn"  href="vendorlist.php">Vendors</a>
                                 <h1></h1>
                                <a class="btn"  href="deliverymanlist.php">Delivery man</a>
                                <h1></h1>
                        </fieldset>
