...
<html>
    <head>
        ...
        <script>
                             function ajax()
                             {
                                                ...
                                                let tnxid=document.topupForm.tnxid.value;
                                                ...
                                                if (tnxid == "") {
                                                 ...
                                                 else
                                                 {
                                                        ...
                                                        xhttp.open('post', '../controllers/topuphandler.php', true);
 ...
 <!-- <li> <a href="admindashboard.php">Admin Dashboard</a></li>
                ...
                <td>
                <form name="topupForm" action="../controllers/topuphandler.php" method="POST" onsubmit="return validateForm()">
                    
                  
                        <h2>Enter Transaction ID</h2> <br>
                       <input id="transactionid" class="input" type="text" name="tnxid" value=""/>
                            <input class="button" type="button" name="submit" value="Submit" onclick="ajax()">
                    
                            </form>

                    <h3 style="color: green;" id="id1"></h3>
                </td>
...
<script>
     ...
     var tnxid = document.forms["topupForm"]["tnxid"].value;
         if (tnxid == "") {
            alert("Transaction ID must be filled out");
              return false;
                }
