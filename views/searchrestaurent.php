<?php
require_once '../models/restaurentmodel.php';
session_start();
    ...
    <center>
        <table  height=720 width=1080>
            ...
            <tr>
                ...
                <td>
                <form action="searchrestaurent.php" method="POST">
                Search Restaurent <input class="inputfield" type="text" name="searchrestaurent" value=""/> 
...
$search=$_REQUEST['searchrestaurent'];
searchrestaurent($search);
}
...
?>
            ...
            <tr>
                <td colspan="2" align="center"><fieldset class="fielset">
